...
export const Begin = () => {
  ...
  return (
    <section className="box-border px-[10%] pt-24 flex flex-col gap-6 items-center relative">
      ...
      <h1 className="text-white text-[4rem] font-bold">Welcome everyone</h1>
      <div className="flex gap-[40px] align-center">
        ...
        <p className="text-[#BCBCBC] text-[2.24rem] font-medium w-1/2">
          I specialize in web development, but at the same time I can code
          anything related to software development including bots, mobile and
          desktop applications. Contact me you have any requests.
        </p>
      </div>
