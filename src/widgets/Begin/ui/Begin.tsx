...
export const Begin = () => {
    ...
    return (
        <section className="box-border px-[10%] pt-24 flex flex-col gap-6 items-start relative">
            <img
                className="absolute right-0 top-3 max-w-[600px]"
                src={drawing}
            />
            ...
            <p className="text-[#BCBCBC] text-[2.24rem] font-medium w-1/2">
                Welcome again. There is going to be some text here. with a lot
                of symbols uhuuuu
            </p>
